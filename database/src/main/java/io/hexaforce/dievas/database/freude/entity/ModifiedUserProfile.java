...
/**
 * The persistent class for the modified_user_profile database table.
 * 
 */
@Entity
@Table(name = "modified_user_profile")
@NamedQuery(name = "ModifiedUserProfile.findAll", query = "SELECT m FROM ModifiedUserProfile m")
public class ModifiedUserProfile implements Serializable {
	...
	@Column(name = "portrait_file_state")
	private String portraitFileState;
	...
	public String getPortraitFileState() {
		return this.portraitFileState;
	}
	...
	public void setPortraitFileState(String portraitFileState) {
		this.portraitFileState = portraitFileState;
	}
