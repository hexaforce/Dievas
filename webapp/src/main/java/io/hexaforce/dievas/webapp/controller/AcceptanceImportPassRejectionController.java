...
public class AcceptanceImportPassRejectionController {
	@Autowired
	private AcceptanceImportPassRejectionService acceptanceImportPassRejection;

	@ResponseBody
	@GetMapping(value = "/acceptance_import_pass_rejection/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(acceptanceImportPassRejection.serviceName(), HttpStatus.OK);
	}
}
