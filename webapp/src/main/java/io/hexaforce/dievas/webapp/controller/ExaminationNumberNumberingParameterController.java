...
public class ExaminationNumberNumberingParameterController {
	@Autowired
	private ExaminationNumberNumberingParameterService examinationNumberNumberingParameter;

	@ResponseBody
	@GetMapping(value = "/examination_number_numbering_parameter/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(examinationNumberNumberingParameter.serviceName(), HttpStatus.OK);
	}
}
