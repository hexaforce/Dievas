...
public class ExaminationNumberTemporaryProcessController {
	@Autowired
	private ExaminationNumberTemporaryProcessService examinationNumberTemporaryProcess;

	@ResponseBody
	@GetMapping(value = "/examination_number_temporary_process/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(examinationNumberTemporaryProcess.serviceName(), HttpStatus.OK);
	}
}
