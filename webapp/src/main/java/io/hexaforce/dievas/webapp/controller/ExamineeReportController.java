...
@RestController
@RequestMapping("/api")
public class ExamineeReportController {
	@Autowired
	private ExamineeReportService examineeReport;

	@ResponseBody
	@GetMapping(value = "/examinee_report/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(examineeReport.serviceName(), HttpStatus.OK);
	}
}
