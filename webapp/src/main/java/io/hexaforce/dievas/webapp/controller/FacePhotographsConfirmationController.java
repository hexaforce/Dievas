...
public class FacePhotographsConfirmationController {
	@Autowired
	private FacePhotographsConfirmationService facePhotographsConfirmation;

	@ResponseBody
	@GetMapping(value = "/face_photographs_confirmation/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(facePhotographsConfirmation.serviceName(), HttpStatus.OK);
	}
}
