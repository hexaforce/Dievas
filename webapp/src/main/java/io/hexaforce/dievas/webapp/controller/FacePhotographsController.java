...
@RestController
@RequestMapping("/api")
public class FacePhotographsController {
	@Autowired
	private FacePhotographsService facePhotographs;

	@ResponseBody
	@GetMapping(value = "/face_photographs/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(facePhotographs.serviceName(), HttpStatus.OK);
	}
}
