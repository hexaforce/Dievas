...
@RestController
@RequestMapping("/api")
public class MailDistributionListController {
	@Autowired
	private MailDistributionListService mailDistributionList;

	@ResponseBody
	@GetMapping(value = "/mail_distribution_list/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(mailDistributionList.serviceName(), HttpStatus.OK);
	}
}
