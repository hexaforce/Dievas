...
@RestController
@RequestMapping("/api")
public class PersonalInformationChangeRequestController {
	@Autowired
	private PersonalInformationChangeRequestService personalInformationChangeRequest;

	@ResponseBody
	@GetMapping(value = "/personal_information_change_request/")
	public ResponseEntity<String> serviceName() {
		return new ResponseEntity<String>(personalInformationChangeRequest.serviceName(), HttpStatus.OK);
	}
}
